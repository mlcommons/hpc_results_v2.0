...
class Flags:
    ...
    def add_core_args(self):
        ...
        self.parser.add_argument("--jobs", type=int, default=8, help="Number of jobs for copying dataset")
        ...
        self.parser.add_argument("--eval_batch_size", type=int, default=70)
        self.parser.add_argument("--load_balancing", type=str, default="neighbors")
        self.parser.add_argument("--nodes_for_eval", type=int, default=0)
        self.parser.add_argument("--domain", type=str, default="node")
