...
if __name__ == "__main__":
    ...
    parser.add_argument("--datadir", type=str, help="Path to the target data directory")
    ...
    args, _ = parser.parse_known_args()
    get_data(datadir=args.datadir, task=args.task, split=args.split, del_intmd_files=not args.keep)
